...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let HelpembedDescContent =
            ...
            "`2ez Bot V2` is an open source Discord Bot developed by Marwin, MajesticCrits and Turbo. \n \n" +

            "Support the dev: [Click here](https://www.buymeacoffee.com/marwin)";

        let SupportEmbedDescContent =
            " This Bot is made possible due to our amazing donators! \n \n" +
            "Thank you `MYSFT#6969`, `Cointree#8708`, `Shadowss#5513`, `MidoriRyuu#1222` and `hjortsater#0890` \n \n" +
